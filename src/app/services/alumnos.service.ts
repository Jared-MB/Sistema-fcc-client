...
export class AlumnosService {
  ...
  public registrarAlumno(data: Partial<Student>): Observable<any> {
    return this.http.post<any>(`${environment.url_api}/student/`, data)
  }
  ...
  public getAlumnoByID(idUser: number): Observable<any> {
    return this.http.get<any>(`${environment.url_api}/student/?id=${idUser}`);
  }
